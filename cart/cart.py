...
Create little id that sort of stays on the users computer as a cookie
"""
...
class Cart():
    def __init__(self, request):
        ...
        # If user is new, no session key. Let's create one
    ...
    def get_prods(self):
        ...
        # Use ids to lookup products in database module
